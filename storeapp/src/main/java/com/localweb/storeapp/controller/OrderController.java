...
import com.localweb.storeapp.payload.saveDTO.OrderSaveDTO;
...
public class OrderController {
    ...
    public ResponseEntity<OrderProductDTO> addProduct(@Valid @RequestBody OrderProductSaveDTO orderProductSaveDTO, @PathVariable("id") int orderId) {
